...
<p class="has-openrunde-font-family has-4-x-large-font-size" style="letter-spacing:-0.25rem">ⒸⓋ</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:column {"width":"33.33%"} -->
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:navigation {"overlayMenu":"never","style":{"typography":{"fontStyle":"normal","fontWeight":"600","textTransform":"uppercase","lineHeight":"1.2"}},"fontSize":"small","layout":{"type":"flex","orientation":"vertical"}} -->
...
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:paragraph {"metadata":{"name":"Address line"},"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontFamily":"openrunde"} -->
<p class="has-openrunde-font-family" style="font-style:normal;font-weight:600"><?php esc_html_e('51027 Hwy 6 and 24', 'metis');?><br><?php esc_html_e('Glenwood Springs, CO', 'metis');?><br><?php esc_html_e('81601, USA', 'metis');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"top","width":""} -->
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:paragraph {"metadata":{"name":"Address line"},"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"large","fontFamily":"openrunde"} -->
<p class="has-openrunde-font-family has-large-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e('E.', 'metis');?> <a href="mailto:#"><?php esc_html_e('cora@landmark.studio', 'metis');?></a><br><?php esc_html_e('P. (970) 945-5444', 'metis');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:social-links {"iconColor":"theme-2","iconColorValue":"#1A1A1A","className":"is-style-logos-only","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|20"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"metadata":{"name":"Last line"},"style":{"spacing":{"blockGap":{"top":"var:preset|spacing|40","left":"var:preset|spacing|20"}}},"layout":{"type":"flex","flexWrap":"wrap","verticalAlignment":"center","justifyContent":"space-between"}} -->
