...
<!-- wp:group {"tagName":"section","metadata":{"name":"About, ledger and portrait","patternName":"metis/about-b","description":"Label-left ledger rows — awards, influences, approach — closed by a portrait and contact block.","categories":["About"]},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|60"},"border":{"top":{"color":"var:preset|color|theme-3","style":"dotted","width":"1px"},"right":[],"bottom":[],"left":[]}},"layout":{"type":"constrained"},"anchor":"about"} -->
<section class="wp-block-group alignwide" id="about" style="border-top-color:var(--wp--preset--color--theme-3);border-top-style:dotted;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:columns {"verticalAlignment":"top","align":"wide","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|60"}}}} -->
<div class="wp-block-columns alignwide are-vertically-aligned-top"><!-- wp:column {"verticalAlignment":"top","width":"22%"} -->
...
<!-- wp:group {"tagName":"section","metadata":{"name":"Selected work, accordion list","patternName":"metis/features-b","description":"Selected projects as an expandable list — each row opens to a short account, credits, and a link. No thumbnails.","categories":["Portfolio"]},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|50"},"border":{"top":{"color":"var:preset|color|theme-3","style":"dotted","width":"1px"},"right":[],"bottom":[],"left":[]}},"layout":{"type":"constrained"},"anchor":"work"} -->
<section class="wp-block-group alignwide" id="work" style="border-top-color:var(--wp--preset--color--theme-3);border-top-style:dotted;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:heading {"align":"wide"} -->
...
<!-- wp:paragraph {"textColor":"theme-3","fontSize":"x-small","fontFamily":"recursive-mono"} -->
...
<!-- wp:group {"tagName":"section","metadata":{"name":"Experience, dated roles","patternName":"metis/career-a","description":"A work history as a dated ledger — year on the left, role and place on the right, one row each.","categories":["Text"]},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|40"},"border":{"top":{"color":"var:preset|color|theme-3","style":"dotted","width":"1px"},"right":[],"bottom":[],"left":[]}},"layout":{"type":"constrained"},"anchor":"experience"} -->
<section class="wp-block-group alignwide" id="experience" style="border-top-color:var(--wp--preset--color--theme-3);border-top-style:dotted;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:heading {"align":"wide"} -->
<h2 class="wp-block-heading alignwide"><?php esc_html_e('Experience', 'metis');?></h2>
<!-- /wp:heading -->

<!-- wp:group {"metadata":{"name":"Role"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|30"}},"border":{"top":{"color":"var:preset|color|theme-3","style":"solid","width":"1px"},"right":[],"bottom":[],"left":[]}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide" style="border-top-color:var(--wp--preset--color--theme-3);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--30)"><!-- wp:columns {"verticalAlignment":"top","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|40"}}}} -->
...
<p class="has-theme-3-color has-text-color has-small-font-size"><?php esc_html_e('Editorial and information design — the studio’s maps, its sites, and the quarterly Almanac.', 'metis');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"theme-3","fontSize":"small"} -->
<p class="has-theme-3-color has-text-color has-small-font-size"><?php esc_html_e('Atlases and reference books. Learned to make a page hold a great deal without raising its voice.', 'metis');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"theme-3","fontSize":"small"} -->
<p class="has-theme-3-color has-text-color has-small-font-size"><?php esc_html_e('Book covers and interiors — where she learned to make a jacket carry a whole argument.', 'metis');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"theme-3","fontSize":"small"} -->
<p class="has-theme-3-color has-text-color has-small-font-size"><?php esc_html_e('Where she learned, mostly, what not to do.', 'metis');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></section>
...
<!-- wp:group {"tagName":"section","metadata":{"name":"Sound, playlist","patternName":"metis/playlist-a","description":"A static stand-in for the core Playlist block — cover, waveform, now-playing bar, and a numbered tracklist. Swap for the real Playlist block once audio and covers exist.","categories":["Portfolio"]},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|50"},"border":{"top":{"color":"var:preset|color|theme-3","style":"dotted","width":"1px"},"right":[],"bottom":[],"left":[]}},"layout":{"type":"constrained"},"anchor":"sound"} -->
<section class="wp-block-group alignwide" id="sound" style="border-top-color:var(--wp--preset--color--theme-3);border-top-style:dotted;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:group {"metadata":{"name":"Intro"},"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
...
<!-- wp:group {"tagName":"section","metadata":{"name":"Contact, display heading","patternName":"metis/contact-b","description":"A closing call to action — an oversized Contact heading that links to email, with a short open-to-work line.","categories":["Contact"]},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|30"},"border":{"top":{"color":"var:preset|color|theme-3","style":"dotted","width":"1px"},"right":[],"bottom":[],"left":[]}},"layout":{"type":"constrained"},"anchor":"contact"} -->
<section class="wp-block-group alignwide" id="contact" style="border-top-color:var(--wp--preset--color--theme-3);border-top-style:dotted;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:heading {"align":"wide","fontSize":"4-x-large"} -->
