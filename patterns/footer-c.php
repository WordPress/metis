 ...
 */
?>
<!-- wp:group {"tagName":"footer","metadata":{"name":"Footer, watermark on gradient","patternName":"metis/footer-c"},"className":"clip-overflow","style":{"spacing":{"padding":{"top":"var:preset|spacing|70"},"margin":{"top":"0","bottom":"0"}},"background":{"gradient":"var:preset|gradient|gradient-8"}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:navigation {"overlayMenu":"never","style":{"typography":{"fontWeight":"600"},"spacing":{"blockGap":"0"}},"fontSize":"small","layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
...
<!-- wp:group {"metadata":{"name":"Last line"},"align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"layout":{"type":"flex","flexWrap":"wrap","verticalAlignment":"center","justifyContent":"space-between"}} -->
<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--60);margin-bottom:var(--wp--preset--spacing--60)"><!-- wp:group {"metadata":{"name":"Top"},"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|20"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
<!-- wp:paragraph {"metadata":{"name":"Site Title + Fit Text"},"align":"full","style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1"},"spacing":{"margin":{"bottom":"-0.25em"}},"elements":{"link":{"color":{"text":"var:preset|color|theme-4"}}}},"textColor":"theme-4","fontFamily":"openrunde","fitText":true} -->
<p class="alignfull has-fit-text has-theme-4-color has-text-color has-link-color has-openrunde-font-family" style="margin-bottom:-0.25em;font-style:normal;font-weight:600;line-height:1"><?php esc_html_e('Mētis', 'metis');?></p>
<!-- /wp:paragraph --></footer>
<!-- /wp:group -->
