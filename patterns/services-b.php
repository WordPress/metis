 ...
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Selected builds"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|70"}},"backgroundColor":"theme-6","layout":{"type":"constrained"},"anchor":"builds"} -->
<section class="wp-block-group alignwide has-theme-6-background-color has-background" id="builds" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)"><!-- wp:heading {"align":"wide","fontSize":"medium"} -->
<h2 class="wp-block-heading alignwide has-medium-font-size"><?php esc_html_e( 'Selected builds', 'metis' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:accordion {"align":"wide","backgroundColor":"theme-6"} -->
<div role="group" class="wp-block-accordion alignwide has-theme-6-background-color has-background"><!-- wp:accordion-item {"style":{"spacing":{"margin":{"top":"-40px","bottom":"0"}},"border":{"top":{"width":"1px","style":"dotted"},"right":[],"bottom":[],"left":[]}},"backgroundColor":"theme-6"} -->
<div class="wp-block-accordion-item has-theme-6-background-color has-background" style="border-top-style:dotted;border-top-width:1px;margin-top:-40px;margin-bottom:0"><!-- wp:accordion-heading {"fontSize":"4-x-large"} -->
...
<!-- wp:accordion-panel {"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|70"}}},"backgroundColor":"theme-6"} -->
<div role="region" class="wp-block-accordion-panel has-theme-6-background-color has-background" style="padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:paragraph -->
...
<!-- wp:accordion-item {"style":{"spacing":{"margin":{"top":"-40px","bottom":"0"}},"border":{"top":{"width":"1px","style":"dotted"},"right":[],"bottom":[],"left":[]}},"backgroundColor":"theme-6"} -->
<div class="wp-block-accordion-item has-theme-6-background-color has-background" style="border-top-style:dotted;border-top-width:1px;margin-top:-40px;margin-bottom:0"><!-- wp:accordion-heading {"fontSize":"4-x-large"} -->
