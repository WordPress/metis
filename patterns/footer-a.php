 ...
 */
?>
<!-- wp:group {"tagName":"footer","metadata":{"name":"Footer, tagline and pill bar","patternName":"metis/footer-a"},"style":{"border":{"right":{"color":"var:preset|color|theme-1","width":"10px"},"bottom":{"color":"var:preset|color|theme-1","width":"10px"},"left":{"color":"var:preset|color|theme-1","width":"10px"}},"spacing":{"blockGap":"var:preset|spacing|80"},"@tablet":{"border":{"width":"0px","style":"none"}},"@mobile":{"border":{"width":"0px","style":"none"}},"background":{"gradient":"var:preset|gradient|gradient-8"}},"layout":{"type":"constrained"}} -->
<footer class="wp-block-group" style="border-right-color:var(--wp--preset--color--theme-1);border-right-width:10px;border-bottom-color:var(--wp--preset--color--theme-1);border-bottom-width:10px;border-left-color:var(--wp--preset--color--theme-1);border-left-width:10px"><!-- wp:columns {"align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}}} -->
